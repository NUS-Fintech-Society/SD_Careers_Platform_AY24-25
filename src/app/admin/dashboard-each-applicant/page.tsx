...
export default function AdminDashboardEachApplicantPage() {
    ...
    const renderDetail = (label: string, value: string) => (
        <div className="grid grid-cols-3 w-full items-center pb-3">
            ...
            <div className="col-span-2 p-2 border border-gray-300 bg-gray-100 rounded-md">
                {value}
            </div>
        </div>
    );
        ...
        <div className="min-h-screen flex flex-col items-center justify-center font-body">
            <div className="flex flex-col lg:flex-row w-full max-w-6xl p-4 items-start">
                ...
                <div className="flex flex-col gap-6 p-8 w-full max-w-4xl border border-gray-200 shadow-md rounded-lg bg-white mb-12 mt-12">
                    <h2 className="font-header text-4xl font-extrabold text-blue-900 mb-6">Participant Submission</h2>
